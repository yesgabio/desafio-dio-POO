...
public class Main {
        public static void main(String[] args){
            ...
            System.out.println("Conteudos Inscritos Gabriela: "+devGabriela.getConteudosInscritos());
            devGabriela.progredir();
            devGabriela.progredir();
            System.out.println("-");
            System.out.println("Conteudos Inscritos Gabriela: "+devGabriela.getConteudosInscritos());            
            System.out.println("Conteudos Concluídos Gabriela: "+devGabriela.getConteudosConcluidos());
